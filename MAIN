    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int tamanhoX : tamanhosTabela) {
            for (int tamanhoConjunto : tamanhosConjunto) {
                ...
                HashEncadeado tabela = new HashEncadeado(tamanhoX);
                ...
                String nomeArquivo = "insercao_encadeamento_" + tamanhoX + "_" + tamanhoConjunto + ".txt";
                ...
                int[] top3 = tabela.tresMaioresListas();
                pw.println("Maior lista: " + top3[0]);
                pw.println("2ª maior lista: " + top3[1]);
                pw.println("3ª maior lista: " + top3[2]);
